...
/* tree_fix handles rule breaking of two reds in a row consecutively and rotates
   @PARAM b to be checked and fixed.
   @RETURN fixed tree.
*/
...
/*tree_free frees all memory associated with the tree
  @PARAM tree type.
...
/* tree_insert creates a tree if there is not one.                                               
   if the key is null then will allocate memory,                                     
   and insert the string.                                                            
   traverses the tree to find appropriate node,                                       
...
/* processes parent node before child node so that it shows the shape of the tree
   @PARAM b tree to be processed
...
/* searches for specific strings in the tree.                                             
...
/* outputs the nodes of the tree in dot format                                      
   @PARAM tree tree to be output
   @PARAM out output file name                                                                 
*/
